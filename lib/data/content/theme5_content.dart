...
class Theme5Content {
  ...
  static List<VocabModel> get vocabulary => [
    ...
    VocabModel(
      ...
      exampleVi: 'Rạp hát rất đông vì nam diễn viên chính là người nổi tiếng.',
    ),
    VocabModel(
      id: 'v05_04',
      wordEn: 'art',
    ...
    VocabModel(
      ...
      exampleVi: 'Bảo tàng cung cấp vé giảm giá cho sinh viên vào cuối tuần.',
    ),
    VocabModel(
      id: 'v05_06',
      wordEn: 'media',
    ...
    VocabModel(
      ...
      exampleVi: 'Tôi đọc về buổi hoà nhạc trên báo và mua vé qua mạng.',
    ),
    VocabModel(
      id: 'v05_08',
      wordEn: 'magazine',
    ...
    VocabModel(
      ...
      partOfSpeech: 'v',
      themeId: 'theme_05_entertainment',
      exampleEn: 'You can obtain tickets by telephone or at the box office.',
      exampleVi:
    ...
    VocabModel(
      ...
      exampleVi: 'Bài đánh giá gợi ý xem vở kịch vì cốt truyện cảm động.',
    ),
    VocabModel(
      id: 'v05_12',
      wordEn: 'mood',
    ...
    VocabModel(
      ...
      partOfSpeech: 'n',
      themeId: 'theme_05_entertainment',
      exampleEn: 'The actor showed strong emotion during the final scene.',
      exampleVi: 'Nam diễn viên thể hiện cảm xúc mạnh mẽ trong cảnh cuối.',
    ),
    VocabModel(
      id: 'v05_14',
      wordEn: 'performer',
    ...
    VocabModel(
      ...
      partOfSpeech: 'n',
      themeId: 'theme_05_entertainment',
      exampleEn: 'The audience was silent at first but later applauded loudly.',
      exampleVi: 'Khán giả ban đầu im lặng nhưng sau đó vỗ tay rất lớn.',
    ),
    VocabModel(
      id: 'v05_16',
      wordEn: 'concert',
    ...
    VocabModel(
      ...
      partOfSpeech: 'np',
      themeId: 'theme_05_entertainment',
      exampleEn: 'She got the lead role after months of auditions.',
      exampleVi: 'Cô ấy nhận được vai chính sau nhiều tháng thử vai.',
    ),
    VocabModel(
      id: 'v05_20',
      ...
      partOfSpeech: 'np',
      themeId: 'theme_05_entertainment',
      exampleEn: 'The supporting actor delivered an unforgettable performance.',
      exampleVi: 'Nam diễn viên phụ đã có một màn diễn khó quên.',
    ),
    VocabModel(
      id: 'v05_21',
      wordEn: 'drama',
    ...
    VocabModel(
      ...
      exampleVi: 'Dù là bi kịch, kết thúc lại bất ngờ rất cảm động.',
    ),
    VocabModel(
      id: 'v05_23',
      wordEn: 'comedy',
      ...
      exampleVi: 'Vở hài kịch hài hước đến mức cả khán phòng cười suốt.',
    ),
    VocabModel(
      id: 'v05_24',
      ...
      exampleVi: 'Sau bài hát cuối, ca sĩ nhận được tràng pháo tay đứng dậy.',
    ),
    VocabModel(
      id: 'v05_25',
      wordEn: 'moving',
      ...
      exampleVi: 'Bộ phim rất cảm động, đặc biệt là cảnh gia đình đoàn tụ.',
    ),
    VocabModel(
      id: 'v05_26',
      wordEn: 'sentimental',
    ...
    VocabModel(
      ...
      exampleVi: 'Nửa đầu khá chán, nhưng nửa sau cải thiện rất nhiều.',
    ),
    VocabModel(
      id: 'v05_29',
      wordEn: 'celebrity',
    ...
    VocabModel(
      ...
      partOfSpeech: 'n',
      themeId: 'theme_05_entertainment',
      exampleEn: 'Please keep the aisle clear during the performance.',
      exampleVi: 'Vui lòng giữ lối đi thông thoáng trong khi biểu diễn.',
    ),
    VocabModel(
      id: 'v05_31',
      wordEn: 'lobby',
      ...
      partOfSpeech: 'n',
      themeId: 'theme_05_entertainment',
      exampleEn: 'Let’s meet in the lobby before the play starts.',
      exampleVi: 'Hãy gặp nhau ở sảnh trước khi vở kịch bắt đầu.',
    ),
    VocabModel(
      id: 'v05_32',
      wordEn: 'recommend',
      ...
      exampleVi: 'Bạn có gợi ý bộ phim này cho người thích hài kịch không?',
    ),
    VocabModel(
      id: 'v05_33',
      ...
      partOfSpeech: 'n',
      themeId: 'theme_05_entertainment',
      exampleEn: 'The cinematography made the city look stunning at night.',
      exampleVi:
    ...
    VocabModel(
      ...
      partOfSpeech: 'n',
      themeId: 'theme_05_entertainment',
      exampleEn: 'The producer approved the budget for the special effects.',
      exampleVi: 'Nhà sản xuất đã duyệt ngân sách cho hiệu ứng đặc biệt.',
    ),
    VocabModel(
      id: 'v05_36',
      ...
      exampleVi: 'Hiệu ứng đặc biệt rất ấn tượng, nhất là trong cảnh cuối.',
    ),
    VocabModel(
      id: 'v05_37',
      wordEn: 'composer',
      ...
      partOfSpeech: 'n',
      themeId: 'theme_05_entertainment',
      exampleEn: 'The composer wrote the soundtrack for more than ten movies.',
      exampleVi: 'Nhà soạn nhạc đã viết nhạc phim cho hơn mười bộ phim.',
    ),
    VocabModel(
      id: 'v05_38',
      wordEn: 'microphone',
      ...
      partOfSpeech: 'n',
      themeId: 'theme_05_entertainment',
      exampleEn: 'The performer adjusted the microphone to improve the sound.',
      exampleVi: 'Người biểu diễn chỉnh micro để cải thiện âm thanh.',
    ),
    VocabModel(
      id: 'v05_39',
      wordEn: 'sound system',
      ...
      exampleVi: 'Rạp hát nâng cấp hệ thống âm thanh lên mẫu kỹ thuật số mới.',
    ),
    VocabModel(
      id: 'v05_40',
      wordEn: 'digital',
      ...
      partOfSpeech: 'adj',
      themeId: 'theme_05_entertainment',
      exampleEn: 'Digital ticketing makes it easier to obtain tickets online.',
      exampleVi: 'Bán vé kỹ thuật số giúp mua vé online dễ hơn.',
    ),
    VocabModel(
      id: 'v05_41',
      ...
      partOfSpeech: 'n',
      themeId: 'theme_05_entertainment',
      exampleEn: 'The advertisement mentioned special prices for children.',
      exampleVi: 'Quảng cáo đề cập mức giá đặc biệt cho trẻ em.',
    ),
    VocabModel(
      id: 'v05_42',
      wordEn: 'promotion',
      ...
      partOfSpeech: 'n',
      themeId: 'theme_05_entertainment',
      exampleEn: 'The promotion offered complimentary tickets to early buyers.',
      exampleVi: 'Chương trình quảng bá tặng vé miễn phí cho người mua sớm.',
    ),
    VocabModel(
      id: 'v05_43',
      wordEn: 'box office',
      ...
      exampleVi: 'Nếu vé online bán hết, hãy thử mua tại phòng vé.',
    ),
    VocabModel(
      id: 'v05_44',
      wordEn: 'matinee',
    ...
    VocabModel(
      ...
      partOfSpeech: 'n',
      themeId: 'theme_05_entertainment',
      exampleEn: 'There are still a few seats for the Thursday night show.',
      exampleVi: 'Vẫn còn vài chỗ ngồi cho suất tối thứ Năm.',
    ),
    VocabModel(
      id: 'v05_47',
      wordEn: 'award',
    ...
    VocabModel(
      ...
      partOfSpeech: 'n',
      themeId: 'theme_05_entertainment',
      exampleEn: 'The 7:30 p.m. screening was canceled due to a safety issue.',
      exampleVi: 'Buổi chiếu 7:30 tối bị huỷ do vấn đề an toàn.',
    ),
    VocabModel(
      id: 'v05_50',
      wordEn: 'patron',
      ...
      partOfSpeech: 'n',
      themeId: 'theme_05_entertainment',
      exampleEn: 'All patrons were asked to leave the building calmly.',
      exampleVi:
    ...
    VocabModel(
      ...
      exampleVi: 'Rạp xin lỗi vì sự bất tiện và đề nghị hoàn tiền.',
    ),
    VocabModel(
      id: 'v05_53',
      wordEn: 'refund',
      ...
      exampleVi: 'Khách hàng có thể nhận hoàn tiền và vé miễn phí tại lối vào.',
    ),
    VocabModel(
      id: 'v05_54',
      ...
      exampleVi: 'Nhân viên phát vé xem phim miễn phí cho tất cả người giữ vé.',
    ),
    VocabModel(
      id: 'v05_55',
      wordEn: 'evacuate',
      ...
      exampleVi: 'Họ phải sơ tán rạp khi báo động không hoạt động bình thường.',
    ),
  ];
  ...
  static List<FabVocabItem> get readingVocab => [
    ...
    const FabVocabItem(
      wordEn: 'supporting actor/actress',
      wordVi: 'Diễn viên phụ',
      pronunciation: '/səˈpɔːrtɪŋ ˈæktər/',
      partOfSpeech: 'np',
    ),
    const FabVocabItem(
      wordEn: 'drama',
  ...
  static List<FabPhraseItem> get readingPhrases => [
    const FabPhraseItem(
      phrase: 'Arrange to meet',
      meaning: 'Sắp xếp để gặp gỡ',
    ),
    const FabPhraseItem(
  ...
  static List<FabAnswerItem> get readingAnswers => const [
    ...
    FabAnswerItem(vi: 'rạp hát', en: 'theatre'),
    ...
    FabAnswerItem(
      vi: 'các tâm trạng và tình cảm',
      en: 'the moods and emotions',
    ),
    ...
    FabAnswerItem(vi: 'ủy mị', en: 'sentimental'),
  ...
  static List<FabPhraseItem> get conversationPhrases => [
    const FabPhraseItem(
      phrase: 'Try to get the tickets',
      meaning: 'Cố gắng mua vé',
    ),
    const FabPhraseItem(phrase: 'Be sold out', meaning: 'Bị bán hết'),
    const FabPhraseItem(phrase: 'What do you think?', meaning: 'Em nghĩ sao?'),
    const FabPhraseItem(phrase: 'Be free', meaning: 'Rảnh'),
    const FabPhraseItem(
      phrase: 'There\'s no way ...',
      meaning: 'Không có cách nào...',
    ),
    const FabPhraseItem(phrase: 'Make it on time', meaning: 'Tới kịp đúng giờ'),
    const FabPhraseItem(
  ...
  static List<FabAnswerItem> get conversationAnswers => const [
    ...
    FabAnswerItem(vi: 'các buổi biểu diễn tuần tới', en: 'next week\'s shows'),
    FabAnswerItem(
  ...
  static List<FabPhraseItem> get shortTalk1Phrases => [
    ...
    const FabPhraseItem(
      phrase: 'Over the past ... years',
      meaning: 'Trong ... năm qua',
    ),
    const FabPhraseItem(
  ...
  static List<FabAnswerItem> get shortTalk1Answers => const [
    ...
    FabAnswerItem(
      vi: 'bài hát vô cùng nổi tiếng',
      en: 'the extremely popular song',
    ),
  ...
  static List<FabPhraseItem> get shortTalk2Phrases => [
    const FabPhraseItem(
      phrase: 'Apologize for sth',
      meaning: 'Xin lỗi vì điều gì',
    ),
    const FabPhraseItem(phrase: 'Offer a refund', meaning: 'Đề nghị hoàn tiền'),
    const FabPhraseItem(phrase: 'Be able to do sth', meaning: 'Có thể làm gì'),
    const FabPhraseItem(phrase: 'Leave the building', meaning: 'Rời toà nhà'),
    const FabPhraseItem(
    ...
    const FabPhraseItem(
      phrase: 'Walk calmly',
      meaning: 'Đi một cách bình tĩnh',
    ),
    const FabPhraseItem(
      phrase: 'The nearest exit',
      meaning: 'Lối thoát gần nhất',
    ),
    const FabPhraseItem(
      phrase: 'Issue coupons',
      meaning: 'Phát phiếu giảm giá',
    ),
    const FabPhraseItem(
  ...
  static List<FabAnswerItem> get shortTalk2Answers => const [
    FabAnswerItem(
      vi: 'tất cả các khách hàng thân thiết của rạp',
      en: 'all movie theater patrons',
    ),
    FabAnswerItem(vi: 'lưu ý rằng', en: 'note that'),
    FabAnswerItem(vi: 'đã bị hủy', en: 'has been canceled'),
    FabAnswerItem(
      vi: 'hệ thống báo cháy của rạp chiếu phim',
      en: 'the theater\'s fire alarm system',
    ),
    FabAnswerItem(
      vi: 'xin lỗi vì sự bất tiện này',
      en: 'apologize for the inconvenience',
    ),
    FabAnswerItem(vi: 'xin hoàn lại tiền', en: 'offer a refund'),
    FabAnswerItem(
      vi: 'các vé mời xem phim miễn phí',
      en: 'complimentary movie tickets',
    ),
    ...
    FabAnswerItem(
      vi: 'đang không hoạt động bình thường',
      en: 'are not operating correctly',
    ),
    ...
    FabAnswerItem(
      vi: 'cảm ơn vì sự hợp tác của quý vị',
...
Người học cũng sẽ đọc và nghe các bài quảng cáo/các chương trình quảng bá cho các loại hình sự kiện giải trí khác nhau và sẽ cần phải nghe kỹ về giá vé và cách thức để mua được vé (qua mạng, qua điện thoại hay tại phòng bán vé) và liệu có mức giá đặc biệt nào cho trẻ em hay có buổi biểu diễn đặc biệt vào một ngày và giờ đặc biệt nào không ví dụ như là một buổi diễn ban ngày.''',
  ...
  static List<MixedSegment> get _day1MindGameSegments => [
    ...
    const MixedSegment.english('. Conversations are about situations such as '),
    const MixedSegment.vietnamese('kiếm được vé', 'obtaining tickets'),
    const MixedSegment.english(
      ' for an event, listening to times and days of ',
    ),
  ...
  static LessonDay get day2 => LessonDay(
    ...
    phases: [
      ...
      LessonPhase(
        ...
        fabAnswers: [
          const FabAnswerItem(
            vi: 'Câu 1 (D): M nói "tried to get the tickets... but the Monday and Wednesday shows are both sold out" = Họ không thể mua được vé.',
            en: 'Q1 (D): M says "tried to get the tickets... but the Monday and Wednesday shows are both sold out" = They couldn\'t get the tickets.',
          ),
          const FabAnswerItem(
            vi: 'Câu 2 (B): W nói "won\'t be able to get home until 8 p.m. There\'s no way we are going to make it... on time" = Không thể đến rạp đúng giờ.',
            en: 'Q2 (B): W says "won\'t be able to get home until 8 p.m. There\'s no way we are going to make it... on time" = She won\'t be able to get to the theater on time.',
          ),
          const FabAnswerItem(
            vi: 'Câu 3 (A): M đề nghị "let me see whether there are seats available for next week\'s shows" = Xem kịch vào tuần tới.',
            en: 'Q3 (A): M suggests "let me see whether there are seats available for next week\'s shows" = See the play next week.',
          ),
        ],
      ),
      LessonPhase(
        ...
        fabAnswers: [
          const FabAnswerItem(
            vi: 'Câu 4 (A): "Jonathan Walters, composer of the extremely popular song..." = Nhạc sĩ / Nhà soạn nhạc.',
            en: 'Q4 (A): "Jonathan Walters, composer of the extremely popular song..." = Musician.',
          ),
          const FabAnswerItem(
            vi: 'Câu 5 (C): "Over the past 20 years, Mr. Walters has written over 40 hits" = 20 năm.',
            en: 'Q5 (C): "Over the past 20 years, Mr. Walters has written over 40 hits" = 20 years.',
          ),
          const FabAnswerItem(
            vi: 'Câu 6 (B): "he has been the featured artist on the soundtracks for more than 10 movies" = Nhạc phim.',
            en: 'Q6 (B): "he has been the featured artist on the soundtracks for more than 10 movies" = Soundtracks.',
          ),
        ],
      ),
      LessonPhase(
        ...
        fabAnswers: [
          const FabAnswerItem(
            vi: 'Câu 7 (D): "screening... has been canceled due to problems with the theater\'s fire alarm system" = Rạp không an toàn (lỗi báo cháy).',
            en: 'Q7 (D): "screening... has been canceled due to problems with the theater\'s fire alarm system" = The theater isn\'t safe.',
          ),
          const FabAnswerItem(
            vi: 'Câu 8 (C): "ask that all patrons leave the building now as we are required by law to evacuate" = Sơ tán khỏi rạp.',
            en: 'Q8 (C): "ask that all patrons leave the building now as we are required by law to evacuate" = Evacuate the theater.',
          ),
          const FabAnswerItem(
            vi: 'Câu 9 (C): "Our staff will then issue coupons to all tickets-holders" = Nhận phiếu ưu đãi/giảm giá.',
            en: 'Q9 (C): "Our staff will then issue coupons to all tickets-holders" = A coupon.',
          ),
        ],
      ),
      ...
      LessonPhase(
        ...
        audioTrackKey: 'track_20',
        contentEn:
            '''M: Susan, this morning I tried to get the tickets to the play you told me about but the Monday and Wednesday shows are both sold out. However, there are still seats for the Thursday night show. What do you think? Will you be free on Thursday?
...
W: That is really the only one I want to see. My friends have told me so much about the play already.''',
        contentVi:
            '''M: Susan này, sáng nay anh cố gắng mua mấy vé xem vở kịch mà em bảo anh, nhưng những buổi diễn thứ Hai và thứ Tư đều bán hết vé rồi. Tuy nhiên, vẫn còn vài chỗ cho buổi diễn tối thứ Năm. Em nghĩ sao? Em có rảnh vào thứ Năm không?
...
W: Đó thật sự là vở kịch duy nhất mà em muốn xem. Các bạn em đã nói với em rất nhiều về vở kịch này.''',
  ...
  static List<QuizQuestion> get _practice2Questions => [
    const QuizQuestion(
      ...
      options: ['(A) Musician', '(B) Poet', '(C) Actor', '(D) Model'],
      correctIndex: 0,
      audioTrackKey: 'track_21',
    ...
    const QuizQuestion(
      ...
      options: ['(A) 5 years', '(B) 10 years', '(C) 20 years', '(D) 40 years'],
      correctIndex: 2,
      audioTrackKey: 'track_21',
      practiceNumber: 'practice2',
    ),
  ...
  static List<MixedSegment> get _day2ConversationSegments => [
    ...
    const MixedSegment.vietnamese('có một cuộc họp dài', 'have a long meeting'),
    ...
    const MixedSegment.vietnamese('bỏ lỡ phần đầu', 'miss the beginning part'),
    const MixedSegment.english(' of the play.\n\nM: Okay, '),
    const MixedSegment.vietnamese('để anh xem liệu rằng', 'let me see whether'),
  ...
  static List<MixedSegment> get _day2ShortTalk1Segments => [
    ...
    const MixedSegment.english(' "Forever with You". '),
    const MixedSegment.vietnamese(
      'Qua hơn 20 năm qua',
      'Over the past 20 years',
    ),
    const MixedSegment.english(', Mr. Walters has written '),
    const MixedSegment.vietnamese('hơn 40 bài hát nổi tiếng', 'over 40 hits'),
    const MixedSegment.english(' and '),
    const MixedSegment.vietnamese('đã được vinh danh', 'has been honored'),
    ...
    const MixedSegment.vietnamese('trong 5 năm qua', 'in the past 5 years'),
  ...
  static List<MixedSegment> get _day2ShortTalk2Segments => [
    ...
    const MixedSegment.english(' this movie theater when the fire alarms '),
    const MixedSegment.vietnamese(
      'đang không hoạt động bình thường',
      'are not operating correctly',
    ),
    const MixedSegment.english('. Please '),
    const MixedSegment.vietnamese('đi bộ một cách bình tĩnh', 'walk calmly'),
    const MixedSegment.english(' to '),
    ...
    const MixedSegment.vietnamese('Nhân viên của chúng tôi', 'Our staff'),
    const MixedSegment.english(' will then '),
    const MixedSegment.vietnamese('phát các phiếu giảm giá', 'issue coupons'),
    const MixedSegment.english(
      ' to all tickets-holders. CinemaStar Luxury Theater would like to ',
    ),
    const MixedSegment.vietnamese(
