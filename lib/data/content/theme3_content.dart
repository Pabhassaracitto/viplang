...
class Theme3Content {
  ...
  static List<VocabModel> get vocabulary => [
    ...
    VocabModel(
      ...
      pronunciation: '/ˈteknɪkəl ˈeəriəz/',
      partOfSpeech: 'np',
      themeId: 'theme_03_technical_areas',
      exampleEn: 'Our company is expanding into new technical areas.',
      exampleVi:
          'Công ty chúng tôi đang mở rộng sang các lĩnh vực kỹ thuật mới.',
    ),
    VocabModel(
      id: 'v03_37',
      wordEn: 'housing',
      ...
      partOfSpeech: 'n',
      themeId: 'theme_03_technical_areas',
      exampleEn: 'The technical area of housing is very common.',
      exampleVi: 'Lĩnh vực kỹ thuật về nhà đất rất phổ biến.',
    ),
    VocabModel(
      id: 'v03_38',
      ...
      partOfSpeech: 'np',
      themeId: 'theme_03_technical_areas',
      exampleEn: 'The technical personnel will handle the equipment setup.',
      exampleVi: 'Nhân viên kỹ thuật sẽ xử lý việc lắp đặt thiết bị.',
    ),
    VocabModel(
      id: 'v03_39',
      ...
      partOfSpeech: 'np',
      themeId: 'theme_03_technical_areas',
      exampleEn: 'The laboratory is equipped with specialized equipment.',
      exampleVi: 'Phòng thí nghiệm được trang bị thiết bị chuyên dụng.',
    ),
    VocabModel(
      id: 'v03_40',
      ...
      partOfSpeech: 'np',
      themeId: 'theme_03_technical_areas',
      exampleEn: 'The team spent all day solving technical issues.',
      exampleVi: 'Cả nhóm đã dành cả ngày để giải quyết các vấn đề kỹ thuật.',
    ),
    VocabModel(
      id: 'v03_41',
      wordEn: 'lab technician',
      wordVi: 'kỹ thuật viên phòng thí nghiệm',
      pronunciation: '/ˈlæb tekˈnɪʃən/',
      partOfSpeech: 'np',
      themeId: 'theme_03_technical_areas',
      exampleEn: 'The lab technician prepared the samples for the experiment.',
      exampleVi:
          'Kỹ thuật viên phòng thí nghiệm đã chuẩn bị mẫu cho thí nghiệm.',
    ),
    VocabModel(
      id: 'v03_42',
      wordEn: 'flask',
      ...
      partOfSpeech: 'n',
      themeId: 'theme_03_technical_areas',
      exampleEn: 'The researcher filled the flask with the chemical solution.',
      exampleVi: 'Nhà nghiên cứu đã đổ đầy dung dịch hóa chất vào bình.',
    ),
    VocabModel(
      id: 'v03_43',
      wordEn: 'test tube',
      ...
      partOfSpeech: 'np',
      themeId: 'theme_03_technical_areas',
      exampleEn: 'Place the test tube in the rack after the reaction.',
      exampleVi: 'Đặt ống nghiệm lên giá sau khi phản ứng kết thúc.',
    ),
    VocabModel(
      id: 'v03_44',
      wordEn: 'research',
      ...
      partOfSpeech: 'n',
      themeId: 'theme_03_technical_areas',
      exampleEn: 'Scientific research requires a lot of patience.',
      exampleVi: 'Nghiên cứu khoa học đòi hỏi nhiều sự kiên nhẫn.',
    ),
  ];
  ...
  static List<FabPhraseItem> get readingPhrases => [
    ...
    const FabPhraseItem(phrase: 'Need to do sth', meaning: 'Cần làm gì'),
    const FabPhraseItem(
      phrase: 'More than likely',
      meaning: 'Thường thì/Có khả năng cao là',
    ),
  ];
