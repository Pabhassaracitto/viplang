...
class Theme4Content {
  ...
  static List<VocabModel> get vocabulary => [
    ...
    VocabModel(
      id: 'v04_18',
      wordEn: 're-schedule',
      wordVi: 'sắp xếp lại lịch trình',
      pronunciation: '/ˌriːˈskedʒʊl/',
      partOfSpeech: 'v',
      themeId: 'theme_04_travel',
    ...
    VocabModel(
      ...
      pronunciation: '/ˈtrævəl ˈeɪdʒənt/',
      partOfSpeech: 'np',
      themeId: 'theme_04_travel',
