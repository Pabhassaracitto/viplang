...
class Theme9Content {
  ...
  static List<VocabModel> get vocabulary => [
    ...
    VocabModel(
      ...
      pronunciation: '/bi rɪˈleɪtɪd tuː/',
      partOfSpeech: 'vp',
      themeId: 'theme_09_finance_budgeting',
      exampleEn:
    ...
    VocabModel(
      ...
      pronunciation: '/ə ˌkɒnvəˈseɪʃənəl reɪt əv spiːtʃ/',
      partOfSpeech: 'np',
      themeId: 'theme_09_finance_budgeting',
    ...
    VocabModel(
      ...
      pronunciation: '/ˌpɜːsənəl ˈɪnkʌm tæks/',
      partOfSpeech: 'np',
      themeId: 'theme_09_finance_budgeting',
    ...
    VocabModel(
      ...
      pronunciation: '/fækts ənd ˈfɪɡəz/',
      partOfSpeech: 'idiom',
      themeId: 'theme_09_finance_budgeting',
    ...
    VocabModel(
      ...
      pronunciation: '/ˈkʌstəmə ˈsɜːvɪs/',
      partOfSpeech: 'np',
      themeId: 'theme_09_finance_budgeting',
