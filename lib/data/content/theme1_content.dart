...
class Theme1Content {
  ...
  static List<FabVocabItem> get readingVocab => [
    ...
    const FabVocabItem(
      wordEn: 'office equipment',
      pronunciation: '/ˈɔːfɪs ɪˈkwɪpmənt/',
      wordVi: 'Thiết bị văn phòng',
      partOfSpeech: 'np',
    ),
    const FabVocabItem(
      wordEn: 'equipment',
    ...
    const FabVocabItem(
      wordEn: 'purchasing theme',
      pronunciation: '/ˈpɜːrtʃəsɪŋ θiːm/',
      wordVi: 'Chuyên đề Mua sắm trong doanh nghiệp',
      partOfSpeech: 'np',
    ),
    const FabVocabItem(
      wordEn: 'computer',
    ...
    const FabVocabItem(
      wordEn: 'synonyms',
      pronunciation: '/ˈsɪnənɪmz/',
      wordVi: 'Những từ đồng nghĩa',
      partOfSpeech: 'n',
    ),
    const FabVocabItem(
    ...
    const FabVocabItem(
      ...
      wordVi: 'Nghi thức, trang trọng',
      partOfSpeech: 'adj',
    ),
    const FabVocabItem(
      wordEn: 'informal',
      pronunciation: '/ɪnˈfɔːrml/',
      wordVi: 'Thân mật, suồng sã',
      partOfSpeech: 'adj',
    ),
    const FabVocabItem(
      wordEn: 'comprehend',
