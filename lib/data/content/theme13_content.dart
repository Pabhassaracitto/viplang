...
class Theme13Content {
  ...
  static List<VocabModel> get vocabulary => [
    ...
    VocabModel(
      ...
      pronunciation: "/’fûzûkÊl ’ØerëpÂst/",
      partOfSpeech: 'np',
      themeId: 'theme_13_health',
      exampleEn:
    ...
    VocabModel(
      ...
      pronunciation: "/’pî:rsÊnël ’treûnër/",
      partOfSpeech: 'np',
      themeId: 'theme_13_health',
    ...
    VocabModel(
      ...
      pronunciation: "/;ho|mië ’pæØûk fu:d ’sšplÂmënt/",
      partOfSpeech: 'np',
      themeId: 'theme_13_health',
      exampleEn:
