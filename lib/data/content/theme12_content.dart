...
class Theme12Content {
  ...
  static List<VocabModel> get vocabulary => [
    VocabModel(
      ...
      exampleEn: 'The company provides housing for its employees.',
      exampleVi: 'Công ty cung cấp nhà ở cho nhân viên của mình.',
    ),
    VocabModel(
      id: 'v12_02',
      wordEn: 'corporate property',
      wordVi: 'tài sản doanh nghiệp',
      pronunciation: '/ˈkɔːrpərət ˈprɑːpərti/',
      partOfSpeech: 'np',
      themeId: 'theme_12_housing_property',
    ...
    VocabModel(
      ...
      partOfSpeech: 'np',
      themeId: 'theme_12_housing_property',
      exampleEn: 'Building construction requires proper planning.',
      exampleVi: 'Xây dựng tòa nhà đòi hỏi lập kế hoạch thích hợp.',
    ),
    VocabModel(
      id: 'v12_04',
      wordEn: 'engineering',
      wordVi: 'kỹ thuật',
      pronunciation: '/ˌɛndʒɪˈnɪrɪŋ/',
      partOfSpeech: 'n',
      themeId: 'theme_12_housing_property',
      exampleEn: 'Civil engineering is crucial in construction.',
      exampleVi: 'Kỹ thuật dân dụng rất quan trọng trong xây dựng.',
    ),
    VocabModel(
      id: 'v12_05',
      wordEn: 'electricity',
      ...
      partOfSpeech: 'n',
      themeId: 'theme_12_housing_property',
      exampleEn: 'The building has a reliable electricity supply.',
      exampleVi: 'Tòa nhà có nguồn cung cấp điện đáng tin cậy.',
    ),
    VocabModel(
      id: 'v12_06',
      wordEn: 'gas service',
      wordVi: 'dịch vụ khí đốt',
      pronunciation: '/ɡæs ˈsɜːrvɪs/',
      partOfSpeech: 'np',
      themeId: 'theme_12_housing_property',
      exampleEn: 'Gas service is available to all residents.',
      exampleVi: 'Dịch vụ khí đốt có sẵn cho tất cả cư dân.',
    ),
    VocabModel(
      id: 'v12_07',
      wordEn: 'building maintenance',
      wordVi: 'bảo trì tòa nhà',
      pronunciation: '/ˈbɪldɪŋ ˈmeɪntənəns/',
      partOfSpeech: 'np',
      themeId: 'theme_12_housing_property',
      exampleEn: 'Regular building maintenance prevents major issues.',
      exampleVi: 'Bảo trì tòa nhà thường xuyên ngăn chặn các vấn đề lớn.',
    ),
    VocabModel(
      id: 'v12_08',
      wordEn: 'renovation',
      ...
      partOfSpeech: 'n',
      themeId: 'theme_12_housing_property',
      exampleEn: 'The apartment underwent a complete renovation.',
      exampleVi: 'Căn hộ được cải tạo hoàn toàn.',
    ),
    VocabModel(
      id: 'v12_09',
      wordEn: 'repair',
      ...
      partOfSpeech: 'n,v',
      themeId: 'theme_12_housing_property',
      exampleEn: 'The roof needs repair urgently.',
      exampleVi: 'Mái nhà cần được sửa chữa ngay lập tức.',
    ),
    VocabModel(
      id: 'v12_10',
      wordEn: 'parking lot',
      wordVi: 'bãi đỗ xe',
      pronunciation: '/ˈpɑːrkɪŋ lɑːt/',
      partOfSpeech: 'np',
      themeId: 'theme_12_housing_property',
      exampleEn: 'The parking lot has 100 spaces.',
      exampleVi: 'Bãi đỗ xe có 100 chỗ đỗ.',
    ),
    VocabModel(
      id: 'v12_11',
      ...
      partOfSpeech: 'np',
      themeId: 'theme_12_housing_property',
      exampleEn: 'The building offers storage facilities for residents.',
      exampleVi: 'Tòa nhà cung cấp kho chứa đồ cho cư dân.',
    ),
    VocabModel(
      id: 'v12_12',
      wordEn: 'warehouse',
      wordVi: 'kho hàng',
      pronunciation: '/ˈwɛrhaʊs/',
      partOfSpeech: 'n',
      themeId: 'theme_12_housing_property',
      exampleEn: 'The company rents a large warehouse.',
      exampleVi: 'Công ty thuê một kho hàng lớn.',
    ),
    VocabModel(
      id: 'v12_13',
      wordEn: 'superintendent',
      wordVi: 'người giám sát',
      pronunciation: '/ˌsuːpərɪnˈtɛndənt/',
      partOfSpeech: 'n',
      themeId: 'theme_12_housing_property',
      exampleEn: 'The superintendent manages building operations.',
      exampleVi: 'Người giám sát quản lý hoạt động tòa nhà.',
    ),
    VocabModel(
      id: 'v12_14',
      wordEn: 'electrician',
      ...
      partOfSpeech: 'n',
      themeId: 'theme_12_housing_property',
      exampleEn: 'An electrician fixed the wiring problem.',
      exampleVi: 'Một thợ điện đã sửa chữa vấn đề dây dẫn.',
    ),
    VocabModel(
      id: 'v12_15',
      wordEn: 'lease',
      ...
      partOfSpeech: 'n,v',
      themeId: 'theme_12_housing_property',
      exampleEn: 'The lease agreement lasts five years.',
      exampleVi: 'Hợp đồng thuê kéo dài năm năm.',
    ),
    VocabModel(
      id: 'v12_16',
      wordEn: 'tenant',
      ...
      partOfSpeech: 'n',
      themeId: 'theme_12_housing_property',
      exampleEn: 'The new tenant moved in last week.',
      exampleVi: 'Người thuê mới chuyển vào tuần trước.',
    ),
    VocabModel(
      id: 'v12_17',
      wordEn: 'landlord',
      ...
      partOfSpeech: 'n',
      themeId: 'theme_12_housing_property',
      exampleEn: 'The landlord raised the rent this year.',
      exampleVi: 'Chủ nhà tăng tiền thuê năm nay.',
    ),
    VocabModel(
      id: 'v12_18',
      wordEn: 'security deposit',
      wordVi: 'tiền đặt cọc',
      pronunciation: '/sɪˈkjʊrɪti dɪˈpɑːzɪt/',
      partOfSpeech: 'np',
      themeId: 'theme_12_housing_property',
      exampleEn: 'The security deposit is refundable.',
      exampleVi: 'Tiền đặt cọc có thể hoàn lại.',
    ),
    VocabModel(
      id: 'v12_19',
      wordEn: 'utilities',
      ...
      partOfSpeech: 'n',
      themeId: 'theme_12_housing_property',
      exampleEn: 'Utilities are included in the rent.',
      exampleVi: 'Dịch vụ tiện ích được bao gồm trong tiền thuê.',
    ),
    VocabModel(
      id: 'v12_20',
      wordEn: 'rent',
    ...
    VocabModel(
      ...
      partOfSpeech: 'n',
      themeId: 'theme_12_housing_property',
      exampleEn: 'She applied for a mortgage to buy the house.',
      exampleVi: 'Cô ấy nộp đơn xin khoản vay thế chấp để mua nhà.',
    ),
    VocabModel(
      id: 'v12_22',
      wordEn: 'refurbish',
      wordVi: 'tân trang',
      pronunciation: '/rɪˈfɜːrbɪʃ/',
      partOfSpeech: 'v',
      themeId: 'theme_12_housing_property',
      exampleEn: 'They refurbished the office building.',
      exampleVi: 'Họ đã tân trang tòa nhà văn phòng.',
    ),
    VocabModel(
      id: 'v12_23',
      wordEn: 'refit',
      ...
      partOfSpeech: 'v',
      themeId: 'theme_12_housing_property',
      exampleEn: 'The kitchen was refit with modern appliances.',
      exampleVi: 'Nhà bếp được cải tạo với các thiết bị hiện đại.',
    ),
    VocabModel(
      id: 'v12_24',
      wordEn: 'architect',
      ...
      partOfSpeech: 'n',
      themeId: 'theme_12_housing_property',
      exampleEn: 'The architect designed a modern building.',
      exampleVi: 'Kiến trúc sư đã thiết kế một tòa nhà hiện đại.',
    ),
    VocabModel(
      id: 'v12_25',
      wordEn: 'spacious',
      ...
      partOfSpeech: 'adj',
      themeId: 'theme_12_housing_property',
      exampleEn: 'The apartment is spacious and bright.',
      exampleVi: 'Căn hộ rộng rãi và sáng sủa.',
    ),
    VocabModel(
      id: 'v12_26',
      wordEn: 'premises',
      ...
      partOfSpeech: 'n',
      themeId: 'theme_12_housing_property',
      exampleEn: 'The business relocated to new premises.',
      exampleVi: 'Doanh nghiệp chuyển đến cơ sở kinh doanh mới.',
    ),
    VocabModel(
      id: 'v12_27',
      wordEn: 'termination',
      wordVi: 'chấm dứt hợp đồng',
      pronunciation: '/ˌtɜːrmɪˈneɪʃən/',
      partOfSpeech: 'n',
      themeId: 'theme_12_housing_property',
      exampleEn: 'The termination of the lease was agreed upon.',
      exampleVi: 'Sự chấm dứt hợp đồng đã được đồng ý.',
    ),
    VocabModel(
      id: 'v12_28',
      wordEn: 'bright',
      ...
      partOfSpeech: 'adj',
      themeId: 'theme_12_housing_property',
      exampleEn: 'The room is bright with natural light.',
      exampleVi: 'Căn phòng sáng sủa với ánh sáng tự nhiên.',
    ),
    VocabModel(
      id: 'v12_29',
      wordEn: 'wood flooring',
      wordVi: 'sàn gỗ',
      pronunciation: '/wʊd ˈflɔːrɪŋ/',
      partOfSpeech: 'np',
      themeId: 'theme_12_housing_property',
      exampleEn: 'The wood flooring adds elegance to the room.',
      exampleVi: 'Sàn gỗ tăng thêm sự sang trọng cho phòng.',
    ),
    VocabModel(
      id: 'v12_30',
      wordEn: 'renovation schedule',
      wordVi: 'lịch trình cải tạo',
      pronunciation: '/ˌrɛnəˈveɪʃən ˈskɛdʒuːl/',
      partOfSpeech: 'np',
      themeId: 'theme_12_housing_property',
      exampleEn: 'The renovation schedule was delayed.',
      exampleVi: 'Lịch trình cải tạo bị trì hoãn.',
    ),
  ];
